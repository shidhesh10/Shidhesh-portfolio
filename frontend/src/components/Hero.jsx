        ...
        <div className='container mx-auto px-6 flex flex-col md:flex-row items-center justify-between'>
            ...
            <div className='md:w-1/2 mb-10 md:mb-0'>
                <h1 className='text-4xl md:text-6xl font-bold mb-4'>
                    Hi, I'm <span className='text-purple'>Shidhesh Bhatia</span>
                </h1>
                <h2 className="text-2xl md:text-4xl font-semibold mb-6 "><HeroTitle /></h2>
                ...
                <div className='flex space-x-4'>
                    ...
                    <a href="#contact" className='px-6 py-3 border border-purple rounded-lg font-medium hover:bg-purple/20 transition duration-purple-300'>Contact Me</a>
                </div>
            </div>
            ...
            <div className='md:w-1/2 flex justify-center'>
                <div className='relative w-64 h-64 md:w-80 md:h-80'>
                    <div className='absolute inset-0 rounded-full bg-gradient-to-r from-purple to-pink opacity-70'>
                        ...
                        className='relative rounded-full h-64 w-64 md:w-80 md:h-80 object-cover z-10 animate-float' 
                        src={assets.profileImg} loading='eager' fetchPriority='high' decoding='async' alt="Profile picture" />
                    </div>
